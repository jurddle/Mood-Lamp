...
5. Solder the 1000µF capacitor from an available G(ground) to V+(5V). Your Neopixel should look something like this: ![neopixel](https://github.com/jurddle/Mood-Lamp/blob/master/images/neopixel.jpg = 100x100)
